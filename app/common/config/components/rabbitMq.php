...
$consumerList = [
    ...
    //     [ 'consumer-unique-name' => app\components\rabbitmq\UniqueNameConsumer::class]

    ['notify' => [
        'class' => \app\components\rabbitmq\consumers\NameConsumer::class,
...
return= [
    ...
    'consumers' => [
        [
            'name' => 'consumer-name',
            'callbacks' => [
                'queue-name' => app\components\rabbitmq\NameConsumer::class,
            ],
        ],
    ]
];*/
