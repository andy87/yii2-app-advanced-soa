...
Поэтому захотелось создать свой шаблон приложения, который будет работать на PHP >= 8.0 и иметь более расширенную структуру, а так же 
некоторые предустановленные пакеты, с которыми приходится часто пользоваться.
