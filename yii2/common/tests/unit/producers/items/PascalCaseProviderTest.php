 ...
 *
 * @package yii2\common\tests\unit\producers
 *
 * @tag: #boilerplate #common #test #service
 */
class PascalCaseProducerTest extends BaseProducerTest
{
    // {{Boilerplate}}
}