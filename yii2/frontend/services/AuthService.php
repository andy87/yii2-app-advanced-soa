...
class AuthService extends \common\services\AuthService
{
    ...
    public function sendEmailVerifyMail(SignupForm $signupForm): bool
    {
        ...
        return \common\services\EmailService::getInstance()->send($registrationEmail);
    }
    ...
    public function sendEmailRequestPasswordReset(PasswordResetRequestForm $passwordResetRequestForm): bool
    {
        ...
        return \common\services\EmailService::getInstance()->send($requestPasswordResetEmail);
    }
    ...
    public function sendEmailResendVerification(ResendVerificationEmailForm $resendVerificationEmailForm): bool
    {
        ...
        return \common\services\EmailService::getInstance()->send($resendVerificationEmail);
    }
}